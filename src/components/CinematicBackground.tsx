      ...
      <div className="cinematic-container">
        <main className="cinematic-main">
          <header className="cinematic-header">
            <h2 className="subheader">— Keyframers</h2>
          ...
          <img src="https://images.unsplash.com/photo-1558459654-c430be5b0a44?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&ixid=MXwxNDU4OXwwfDF8cmFuZG9tfHx8fHx8fHw&ixlib=rb-1.2.1&q=80&w=960&h=500" alt="" className="cinematic-img" />
          ...
          <img src='https://images.unsplash.com/photo-1603791445824-0050bd436b6d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MXwxNDU4OXwwfDF8cmFuZG9tfHx8fHx8fHw&ixlib=rb-1.2.1&q=80&w=960' alt='' className="cinematic-img" />
        </main>
      </div>
    </div>
  );
